...
var LifecycleSampleApp1 = (function () {
    ...
    LifecycleSampleApp1.prototype.ngOnInit = function () {
        console.log('On init');
    };
    LifecycleSampleApp1.prototype.ngOnDestroy = function () {
...
var OnCHangeExample = (function () {
    function OnCHangeExample() {
        this.display = true;
        this.name = 'Felipe Coury';
        this.comment = 'I am learning so much!';
    }
    OnCHangeExample.prototype.setValues = function (namefld, commentfld) {
        this.name = namefld.value;
        this.comment = commentfld.value;
    };
    OnCHangeExample.prototype.toggle = function () {
        this.display = !this.display;
    };
    OnCHangeExample = __decorate([
        core_1.Component({
...
exports.OnCHangeExample = OnCHangeExample;
var LifeCycleHooksOnChange = (function () {
    function LifeCycleHooksOnChange() {
        this.display = true;
    }
    LifeCycleHooksOnChange.prototype.toggle = function () {
        this.display = !this.display;
    };
    LifeCycleHooksOnChange = __decorate([
        core_1.Component({
        ...
        __metadata('design:paramtypes', [])
    ], LifeCycleHooksOnChange);
    return LifeCycleHooksOnChange;
}());
exports.LifeCycleHooksOnChange = LifeCycleHooksOnChange;
