...
var LifeCycleHooksDoCheck = (function () {
    function LifeCycleHooksDoCheck() {
        this.display = true;
        this.name = 'Felipe Coury';
        this.comment = 'I am learning so much!';
    }
    LifeCycleHooksDoCheck.prototype.setValues = function (namefld, commentfld) {
        this.name = namefld.value;
        this.comment = commentfld.value;
    };
    LifeCycleHooksDoCheck.prototype.toggle = function () {
        this.display = !this.display;
    };
    LifeCycleHooksDoCheck = __decorate([
        core_1.Component({
        ...
        __metadata('design:paramtypes', [])
    ], LifeCycleHooksDoCheck);
    return LifeCycleHooksDoCheck;
}());
exports.LifeCycleHooksDoCheck = LifeCycleHooksDoCheck;
